                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        <div class="content form-inline">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <label for="sqlattacksearch-sqltext">语句：</label>
                                        ...
                                        <div class="content form-inline" style="padding-top: 40px">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label for="sqlattacksearch-sqltext">耗时：</label>
                                                    ...
                                                    <?= Html::activeDropDownList($searchModel, 'databasetype', SqlAttackService::getSqlTraceDbType(), ['class' => 'form-control']) ?>
...
<script type="text/javascript">
    ...
    function checkDate() {
        var start_time = $("#sqlattacksearch-start_date").val();

        start_time = start_time.replace(/-/g, "/");
        var start_d = new Date(start_time);
        var end_time = $("#sqlattacksearch-end_date").val();
