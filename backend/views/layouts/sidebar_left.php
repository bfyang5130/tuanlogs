...
<div id="sidebar-left" class="col-xs-2 col-sm-2">
    <ul class="nav main-menu">
        ...
        <?php /** /?>
          ...
          <li><a class="ajax-link" href="/devoops/ajax/charts_amcharts.html">AmCharts</a></li>
          <li><a class="ajax-link" href="/devoops/ajax/charts_chartist.html">Chartist</a></li>
          ...
          <li><a class="ajax-link" href="/devoops/ajax/map_leaflet.html">Leaflet</a></li>
          </ul>
          </li>
          <li class="dropdown">
          <a href="#" class="dropdown-toggle">
